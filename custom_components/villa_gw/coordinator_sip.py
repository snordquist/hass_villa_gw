...
class VillaGwSipMixin:
    ...
    async def _sip_loop(
        ...
        `SipClient` defaults to `RingingStrategy` (100 Trying + 180 Ringing,
        never 200) — verified 2026-05-30 to let the parallel iPhone fork answer
        (pure silence left the call un-answerable).
        """
