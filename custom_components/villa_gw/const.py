...
# NOTE: the Cloud listener always uses RingingStrategy (100 Trying + 180 Ringing,
# never 200) — it behaves like a real phone so the iPhone fork can still answer.
# (The old `enable_sip_ringing` toggle was removed: pure silence broke answering.)
